...
<body>
                ...
                <form action="addreview.php" method="POST">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="FS1" aria-label="Default select example">
                            ...
                            <?php
                              ...
                              $subjects_db = $conn->query("SELECT * FROM subject where name in ('Englisch','Franzoesisch','Spanisch')");
                              $subjects = [];
                              // Check ob es Ergebnisse in der Abfrage gab
                              if ($subjects_db->num_rows > 0) {
                                  while($subject = $subjects_db->fetch_assoc()){
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="fs2nawi2" id="fs2ornawi21" value="fs2"
                                onclick="fs2()">
                            <label class="form-check-label" for="fs2ornawi21">
                                FS 2
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="fs2nawi2" id="fs2ornawi22" value="nawi2"
                                onclick="nawi2()">
                            <label class="form-check-label" for="fs2ornawi22">
                                Nawi 2
                            </label>
                        </div>
                    </div>

                    <div class="mb-3 d-none" id="FS2">
                        <label for="FS2_Select" class="form-label">2.Fremdsprache*</label>
                        <select class="form-select" id="FS2_Select" aria-label="Default select example">
                            <option selected>Bitte wähle eine Option</option>
                            <?php
                    ...
                    <div class="mb-3 d-none" id="NAWI2">
    ...
    <script>
        ...
        function fs2() {
            console.log("FS2");
            document.getElementById('FS2').classList.remove('d-none');
            document.getElementById('NAWI2').classList.add('d-none');
        }

        function nawi2() {
            console.log("NAWI2");
            document.getElementById('NAWI2').classList.remove('d-none');
            document.getElementById('FS2').classList.add('d-none');
        }
